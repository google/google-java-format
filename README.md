...
```
java -jar /path/to/google-java-format-1.12.0-all-deps.jar <options> [files...]
```
...
Version 1.11 of the
[google-java-format Eclipse plugin](https://github.com/google/google-java-format/releases/download/v1.12.0/google-java-format-eclipse-plugin-1.12.0.jar)
