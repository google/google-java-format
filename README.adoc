...
link:https://scan.coverity.com/projects/mrdolch-configurable-java-format[image:https://scan.coverity.com/projects/31341/badge.svg[Coverity Scan Build Status]]
